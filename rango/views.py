...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            #we hash the password by using below method
        ...
        #We create blank forms, ready for users to fill in
        user_form = UserForm()
    ...
    if request.method == 'POST':
        ...
        if user:
            if user.is_active:
                ...
                return HttpResponse("Tour Rango account is disabled")
...
def visitor_cookie_handler(request):
    ...
    #if its been more then a day since the last visit
